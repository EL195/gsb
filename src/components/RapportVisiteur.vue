                            ...
                            <div class="col-span-10 mt-8">
                                <div class="flex items-center h-10 intro-y">
                                   <img   svg-inline class="icon" src='../assets/img/svg/contract.svg' width="30" height="30"  alt="Praticiens" />                                         
                                    <h2 style="margin-left:5px;margin-top:8px;font-size:30px!important;font-weight: bold;color:#454562;" class="mr-5 text-lg font-medium truncate">Mes rapports</h2>
                            ...
                            <div class="col-span-12 mt-5">
                                ...
                                <div class="grid gap-2 grid-cols-1 lg:grid-cols-1">
                                    <div class="bg-white p-4 shadow-lg rounded-lg" style="border-radius:20px!important;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div class="flex space-x-4">
                                                                                ...
                                                                                <p v-on:click="edit()" class="action">Editer</p>
                                                                                </a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <div>
                                                                <button v-on:click="newr()" class="button">Créer un rapport</button>
                                                            </div>
